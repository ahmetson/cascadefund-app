import { A as AstroError, an as ActionCalledFromServerError, az as REDIRECT_STATUS_CODES, aA as ActionsReturnedInvalidDataError, aB as escape, Y as DEFAULT_404_COMPONENT } from './astro/server_fdX1SiYK.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { PORT: "5555", _: process.env._ })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { PORT: "5555", _: process.env._ })?.PROD) {
