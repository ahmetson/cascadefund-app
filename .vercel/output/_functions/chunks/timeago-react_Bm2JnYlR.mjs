...
import { C as Component } from './Tooltip_CwxsUbL0.mjs';
import { g as getIcon, C as Component$1 } from './BrowseTracker_CjQaYJF4.mjs';
import { B as Button } from './PanelAction_BPm-vUQ5.mjs';
...
const MenuAvatar = ({
  ...
  return /* @__PURE__ */ jsx(Component, { content: tooltipContent, children: /* @__PURE__ */ jsx(Component$1, { uri: profileUri, className: `hover:bg-teal-300 bg-blue-200 dark:bg-blue-400 rounded-full h-8 w-8 flex items-center justify-center overflow-hidden ${className}`, children: /* @__PURE__ */ jsx(
    "img",
    {
      src: finalSrc || defaultSrc,
      alt: finalAlt || defaultAlt,
...
export { Followings as F, MenuAvatar as M, PanelFooter as P, TimeAgo as T };
