...
import { b as getAllGalaxies } from './galaxy_BhIVnuLu.mjs';
import { g as getIssueById } from './issue_D6xZciY4.mjs';
...
async function upsertSpaceUserStar(params) {
  ...
  const { getUserById } = await import('./user_CviJB2en.mjs');
...
async function updateIssueStars(issueId, stars, sunshines) {
  try {
    const { getCollection: getIssueCollection } = await import('./db_CfiMa5UD.mjs');
