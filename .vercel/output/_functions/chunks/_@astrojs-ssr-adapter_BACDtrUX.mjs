import { a7 as ROUTE_TYPE_HEADER, R as REROUTE_DIRECTIVE_HEADER, Y as DEFAULT_404_COMPONENT, A as AstroError, ay as ActionNotFoundError, aa as colors, ae as clientAddressSymbol, aE as LocalsNotAnObject, aF as REROUTABLE_STATUS_CODES, ai as responseSentSymbol, aG as nodeRequestAbortControllerCleanupSymbol, aH as getAugmentedNamespace, aI as commonjsGlobal } from './astro/server_WCbI3U70.mjs';
import 'clsx';
import { D as DEFAULT_404_ROUTE, k as default404Instance, l as ensure404Route } from './astro-designed-error-pages_Dtykzq-O.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_DwV4P9QX.mjs';
