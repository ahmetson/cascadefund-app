import { i as createComponent, j as createAstro, l as addAttribute, aE as renderScript, r as renderTemplate, w as renderComponent, m as maybeRenderHead } from './astro/server_fdX1SiYK.mjs';
import 'clsx';
/* empty css                         */
/* empty css                         */
import { jsx, Fragment, jsxs } from 'react/jsx-runtime';
import { h as hexToRgba } from './utils_CRaJ9uIg.mjs';
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/medet/ara-app/node_modules/.pnpm/astro@5.15.3_@types+node@24.10.0_@vercel+functions@2.2.13_jiti@2.6.1_lightningcss@1.30._58817d952c9f18a1336cf05ca822fcb6/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/medet/ara-app/node_modules/.pnpm/astro@5.15.3_@types+node@24.10.0_@vercel+functions@2.2.13_jiti@2.6.1_lightningcss@1.30._58817d952c9f18a1336cf05ca822fcb6/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer${addAttribute(`backdrop-blur-lg text-slate-500 dark:text-slate-500 flex justify-between p-2 items-center overflow-hidden `, "class")}> <div${addAttribute(`flex space-x-4`, "class")}> ${renderComponent($$result, "Link", Component, { "uri": "/meta/work", "className": " text-slate-600 dark:text-slate-400 transition-colors" }, { "default": ($$result2) => renderTemplate`How it Works?` })} ${renderComponent($$result, "Link", Component, { "uri": "/meta/team", "className": " text-slate-600 dark:text-slate-400 transition-colors" }, { "default": ($$result2) => renderTemplate`Team` })} ${renderComponent($$result, "Link", Component, { "uri": "/meta/policy", "className": " text-slate-600 dark:text-slate-400 transition-colors" }, { "default": ($$result2) => renderTemplate`Privacy Policy (fun-storylike-edition)` })} </div> <div class="">
by ${renderComponent($$result, "Link", Component, { "uri": "https://ara.foundation", "className": " text-slate-600 dark:text-slate-400 transition-colors" }, { "default": ($$result2) => renderTemplate`Ara Foundation` })} </div> </footer>`;
...
var BgType = /* @__PURE__ */ ((BgType2) => {
  ...
  BgType2["heroToSocialization"] = "heroToSocialization";
...
const bgClassNames = {
  ["hero" /* heroSection */]: "bg-gradient-to-br from-blue-500 via-blue-800 to-purple-500 text-white dark:text-gray-900 dark:from-blue-800 dark:via-blue-500 dark:to-purple-800",
  ["heroToInfo" /* heroToInfoViaBlue */]: "bg-gradient-to-bl from-purple-500 via-blue-800 to-gray-100 dark:text-gray-900 dark:from-purple-800 dark:via-blue-500 dark:to-gray-800",
  ["heroToSocialization" /* heroToSocialization */]: "bg-gradient-to-br from-purple-500 via-blue-500 to-blue-600 text-white dark:text-gray-900 dark:from-purple-800 dark:via-blue-500 dark:to-blue-800",
  ["infoToInfo" /* infoToInfoViaBlue */]: "bg-gradient-to-br from-gray-50 via-blue-200 to-gray-50 dark:text-gray-900 dark:from-gray-800 dark:via-blue-500 dark:to-gray-800",
  ["normal" /* normalSection */]: "network-bg text-white dark:text-gray-900 dark:from-gray-900 dark:via-blue-500 dark:to-gray-900",
  ["info" /* infoSection */]: "bg-gray-100 dark:text-gray-900 dark:from-gray-900 dark:via-blue-500 dark:to-gray-900",
  ["fun1" /* purpleToTealViaBlue */]: "bg-gradient-to-br from-purple-600 via-blue-600 to-teal-500 text-white dark:text-gray-900 dark:from-purple-800 dark:via-blue-500 dark:to-teal-800",
  ["fun2" /* blueToPurple */]: "bg-gradient-to-r from-blue-600 to-purple-600 text-white dark:text-gray-900 dark:from-blue-800 dark:to-purple-800",
  ["fun3" /* tealToRedViaLime */]: "bg-gradient-to-br from-teal-500 via-lime-600 to-red-500 text-white dark:text-gray-900 dark:from-teal-800 dark:via-lime-500 dark:to-red-800",
  ["fun4" /* redToPurpleViaLime */]: "bg-gradient-to-bl from-red-500 via-lime-600 to-purple-600 text-white dark:text-gray-900 dark:from-red-800 dark:via-lime-500 dark:to-purple-800",
  ["footer" /* footerToTransparent */]: "bg-gradient-to-b from-gray-900 to-transparent text-gray-600 dark:text-gray-900 dark:from-gray-800 dark:to-transparent",
...
export { $$Logo as $, BgType as B, Component as C, ElectricBorder as E, GridStyle as G, RoundedSize as R, ShadowSize as S, $$ClientRouter as a, $$Footer as b, bgClassNames as c, BorderSize as d, getIcon as g };
