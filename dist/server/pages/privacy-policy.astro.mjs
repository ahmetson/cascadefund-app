import { j as createComponent, x as renderComponent, r as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_BV1oLWnF.mjs';
...
</p> </div> </section> <!-- Decorative separator --> <div class="flex items-center justify-center gap-2 my-12 opacity-50"> <div class="w-1 h-1 rounded-full bg-slate-400 dark:bg-slate-500"></div> <div class="w-2 h-2 rounded-full bg-slate-400 dark:bg-slate-500"></div> <div class="w-1 h-1 rounded-full bg-slate-400 dark:bg-slate-500"></div> </div> <!-- Section 2: Email Tracking (Demo) --> <section class="space-y-8"> <div class="backdrop-blur-md bg-white/30 dark:bg-slate-900/30 border border-purple-200/40 dark:border-purple-700/40 rounded-xl p-6 md:p-8"> <h3 class="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-6 flex items-center gap-3"> <svg class="w-6 h-6 text-purple-500 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path> </svg>
1. Email Tracking (Demo Phase)
</h3> <!-- Email Tracking Flow Diagram --> <div class="mb-6"> <svg viewBox="0 0 500 200" class="w-full h-auto" aria-label="Email tracking flow diagram"> <!-- User --> <g> <circle cx="80" cy="100" r="30" fill="rgb(59, 130, 246)" fill-opacity="0.2" stroke="rgb(59, 130, 246)" stroke-width="2" class="dark:fill-blue-400/20 dark:stroke-blue-400"></circle> <text x="80" y="108" text-anchor="middle" class="text-sm fill-slate-700 dark:fill-slate-300" font-size="14" font-weight="bold">
👤
</text> <text x="80" y="145" text-anchor="middle" class="text-xs fill-slate-600 dark:fill-slate-400" font-size="11">
You
</text> </g> <!-- Arrow --> <path d="M 110 100 L 170 100" stroke="rgb(168, 85, 247)" stroke-width="2.5" fill="none" marker-end="url(#arrow-purple-email)" class="dark:stroke-purple-400"></path> <!-- Email --> <g> <rect x="200" y="60" width="100" height="80" rx="4" fill="rgb(168, 85, 247)" fill-opacity="0.2" stroke="rgb(168, 85, 247)" stroke-width="2" class="dark:fill-purple-400/20 dark:stroke-purple-400"></rect> <text x="250" y="110" text-anchor="middle" class="text-lg fill-slate-700 dark:fill-slate-300" font-size="16">
📧
</text> <text x="250" y="160" text-anchor="middle" class="text-xs fill-slate-600 dark:fill-slate-400" font-size="11">
Email
</text> </g> <!-- Arrow --> <path d="M 300 100 L 360 100" stroke="rgb(168, 85, 247)" stroke-width="2.5" fill="none" marker-end="url(#arrow-purple-email)" class="dark:stroke-purple-400"></path> <!-- Demo Tracking --> <g> <rect x="380" y="60" width="100" height="80" rx="4" fill="rgb(34, 197, 94)" fill-opacity="0.2" stroke="rgb(34, 197, 94)" stroke-width="2" stroke-dasharray="4,4" class="dark:fill-green-400/20 dark:stroke-green-400"></rect> <text x="430" y="105" text-anchor="middle" class="text-sm fill-slate-700 dark:fill-slate-300" font-size="12" font-weight="bold">
Demo
</text> <text x="430" y="120" text-anchor="middle" class="text-sm fill-slate-700 dark:fill-slate-300" font-size="12" font-weight="bold">
Tracking
</text> <text x="430" y="160" text-anchor="middle" class="text-xs fill-slate-600 dark:fill-slate-400" font-size="10">
(Temporary)
</text> </g> <defs> <marker id="arrow-purple-email" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"> <polygon points="0 0, 8 3, 0 6" fill="rgb(168, 85, 247)" class="dark:fill-purple-400"></polygon> </marker> </defs> </svg> </div> <div class="space-y-4"> <p class="text-lg text-slate-700 dark:text-slate-300"> <strong>For the demo version:</strong> We collect your email address when
            you sign up or use Ara. This is temporary and only used to create your
            demo account and track your session.
</p> <p class="text-lg text-slate-700 dark:text-slate-300">
We'll only use it to:
</p> <ul class="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4"> <li>Create and manage your demo account</li> <li>Track your activity during the demo session</li> <li>Send you important updates about Ara (if you opt in)</li> </ul> <p class="text-lg text-slate-700 dark:text-slate-300 mt-4"> <strong>No spam, no selling your email, no creepy stuff.</strong>
Once we move to full blockchain tracking, email usage will be minimized
            or eliminated.
